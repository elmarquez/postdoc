...
function getFileMenu() {
  const createNewFileSubmenu = new nw.Menu();
  createNewFileSubmenu.append(
    new nw.MenuItem({ label: 'Project', click: actions.project.createProject })
  );
  createNewFileSubmenu.append(
    new nw.MenuItem({ label: 'Project from Git Repository' })
  );
  ...
  const recentItemsSubmenu = new nw.Menu();
  ...
  menu.append(
    new nw.MenuItem({
      ...
      key: 'N',
      modifiers: 'cmd',
      submenu: createNewFileSubmenu
    })
  );
  menu.append(new nw.MenuItem({ label: 'Open', key: 'O', modifiers: 'cmd' }));
  menu.append(
    new nw.MenuItem({ label: 'Recent', submenu: recentItemsSubmenu })
  );
  menu.append(new nw.MenuItem({ type: 'separator' }));
